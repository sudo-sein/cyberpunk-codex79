...
| Sytuacja  | PT  | Porażka                                               | Sukces                               | Sukces +5                            |
| --------- | --- | ----------------------------------------------------- | ------------------------------------ | ------------------------------------ |
| Motywacja | 13  | Cierpliwość -1                                        | Cierpliwość -1<br>Zainteresowanie +1 | Zainteresowanie +1                   |
| Neutralny | 17  | Cierpliwość -1<br>Zainteresowanie -1                  | Cierpliwość -1                       | Cierpliwość -1<br>Zainteresowanie +1 |
| Pułapka   | --  | Automatyczna:<br>Cierpliwość -1<br>Zainteresowanie -1 | --                                   | --                                   |
...
| 4 | Entuzjastyczny — korzystna umowa, może coś ekstra. |
| 5 | W pełni przekonany — daje, czego Ekipa chce, na najlepszych warunkach. |
...
| Motywacja/Pułapka              | Opis w kontekście Night City                                                           |
| ------------------------------ | -------------------------------------------------------------------------------------- |
| **Chciwość / Pieniądze**       | BN chce zarobić, zdobyć cenny przedmiot lub zwiększyć swój majątek.                    |
...
| **Sprawiedliwość / Uczciwość** | BN wierzy w reguły, uczciwość i fair play — nawet na Ulicy.                            |
| **Odkrywczość / Wiedza**       | BN jest ciekawy, szuka nowej wiedzy, technologii, doświadczeń.                         |
...
- BG współpracował wcześniej z danym ugrupowaniem, gangiem lub korporacją: 
  **+1 Cierpliwości** (maks. 5).
...
| Sukces | Cierpliwość −1, Zainteresowanie +1 |
| Sukces o 5+ powyżej PT | Zainteresowanie +1 (Cierpliwość bez zmian) |
...
| Sukces | Cierpliwość −1 |
| Sukces o 5+ powyżej PT | Cierpliwość −1, Zainteresowanie +1 |
...
| Wynik        | Efekt                                                                                                    |
| ------------ | -------------------------------------------------------------------------------------------------------- |
| 12 lub mniej | BN orientuje się co próbujesz zrobić. **Cierpliwość −1**.                                                |
...
| Wynik        | Efekt                                                                                                    |
| ------------ | -------------------------------------------------------------------------------------------------------- |
| 12 lub mniej | Błędne wrażenie. BN zauważa, że jest analizowany — **Cierpliwość −1**.                                   |
| 13+          | Gracz poznaje przybliżony poziom **jednego** parametru: Zainteresowania **lub** Cierpliwości (wybór MG). |
...
| Rola            | Zdolność       | Zastosowanie                                                                                  |
| --------------- | -------------- | --------------------------------------------------------------------------------------------- |
| **Fixer**       | Znajomości     | Wazeliniarz: wypytanie z odpowiedniej kultury/grupy o motywacje lub pułapki.                  |
| **Rocker**      | Efekt Charyzmy | Ktoś z grona idoli może coś wiedzieć na ten temat.                                            |
| **Media**       | Wiarygodność   | Odnalezienie wiarygodnego źródła informacji pozwala poznać odpowiednie motywacje lub pułapki. |
| **Stróż Prawa** | Wsparcie       | Być może ktoś na posterunku coś słyszał.                                                      |

**Poziomy trudności wykrycia informacji**

| Poziom | Rola | Skill | Efekt                                                                                                   |
| ------ | ---- | ----- | ------------------------------------------------------------------------------------------------------- |
| Łatwy  | 8    | 13    | Udaje Ci się zdobyć informację o 1 motywacji lub pułapce o ile cel nie ukrywa się z tym zbytnio.        |
| Średni | 10   | 15    | Informacja jest dostępna tylko dla znajomych BN-a i prosi o zachowanie tajemnicy.                       |
| Trudny | 12   | 17    | Motywacje i pułapki znane są tylko najbliższym, a ujawnienie ich wymagało zastosowania jakiejś dźwigni. |
